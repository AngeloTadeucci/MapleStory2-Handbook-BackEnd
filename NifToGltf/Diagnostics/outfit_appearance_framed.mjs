...
const evidence = 'NifToGltf/obj/outfit-studio-20260908/appearance-framed';
...
try {
 ...
 await check('empty appearance icons use inset frames and dark embossed symbols', await page.locator('.appearance-controls').evaluate(el => [...el.querySelectorAll('svg')].every(svg => svg.querySelectorAll('rect').length === 2 && svg.querySelector('g').getAttribute('stroke') === '#202020')));
